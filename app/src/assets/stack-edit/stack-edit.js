            ...
            var o = (function () {
                ...
                c = (function () {
                    function e() {
                        ...
                        i(this, e),
                            (this.$options = {url: "http://localhost:3000/stackedit/app"}),
                            (this.$listeners = {}),
                        ...
                        o(e, [
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    var i = t.content || {},
                                        o = {origin: a, fileName: t.name, contentText: i.text, contentProperties: !i.yamlProperties && i.properties ? JSON.stringify(i.properties) : i.yamlProperties, silent: n},
                                        c = Object.keys(o)
                                            .map(function (e) {
                                    ...
                                    (s.hash = "#" + c),
                                        ...
                                        (this.$containerEl.className = n ? "stackedit-hidden-container" : "stackedit-container"),
                                    ...
                                    d.addEventListener("click", function () {
                                        ...
                                        (this.$messageHandler = function (t) {
                                            if (t.origin === e.$origin && t.source === l.contentWindow)
                                                switch (t.data.type) {
                                                    case "ready":
                                        ...
                                        n || (document.body.className += " stackedit-no-overflow");
                                },
                            },
                            {
                                key: "close",
